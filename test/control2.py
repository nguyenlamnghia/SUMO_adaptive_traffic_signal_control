...
class QuadDQN:
    ...
    def build_model(self):
        model = tf.keras.Sequential([
            tf.keras.layers.Input(shape=(state_size,)),  # Sử dụng Input thay vì input_dim
...
def calculate_reward(old_waiting_time, new_waiting_time, queue_north, queue_south, queue_east, queue_west, green_time, action):
