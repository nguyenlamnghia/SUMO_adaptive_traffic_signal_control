...
def run_phase(phase, green_time):
    ...
    traci.trafficlight.setPhase("J1", phase + 1)  # 1: Bắc-Nam vàng, 3: Đông-Tây vàng
    for _ in range(yellow_time):
        traci.simulationStep()
    traci.trafficlight.setPhase("J1", 4)  # 4: Toàn đỏ
...
def run_simulation():
    ...
    while step < max_steps:
        ...
        phase = 0 if is_north_south else 2  # Bắc-Nam hoặc Đông-Tây
